...
#SBATCH --gres=gpu:1
#SBATCH --output=test_mega_64_epoch-%j.out
...
python3 eval.py \
                             --model_dir "./model_dir/big_model_64_epoch/" \
...
python3 result.py --dev "./model_dir/big_model_24_epoch/Evaluation_dev_processed.json" \
                   --test "./model_dir/big_model_64_epoch/Evaluation_test_split_q1_processed.json" \
                  --model_dir "./model_dir/big_model_64_epoch/" \
                   --threshold_step 0.05
...
python3 result.py --dev "./model_dir/big_model_24_epoch/Evaluation_dev_processed.json" \
                   --test "./model_dir/big_model_64_epoch/Evaluation_test_split_q2_processed.json" \
                   --model_dir "./model_dir/big_model_64_epoch/" \
                   --threshold_step 0.05
...
python3 result.py --dev "./model_dir/big_model_24_epoch/Evaluation_dev_processed.json" \
                   --test "./model_dir/big_model_64_epoch/Evaluation_test_split_q3_processed.json" \
                   --model_dir "./model_dir/big_model_64_epoch/" \
                   --threshold_step 0.05
...
python3 result.py --dev "./model_dir/big_model_24_epoch/Evaluation_dev_processed.json" \
                   --test "./model_dir/big_model_64_epoch/Evaluation_test_split_q4_processed.json" \
                   --model_dir "./model_dir/big_model_64_epoch/" \
                   --threshold_step 0.05
